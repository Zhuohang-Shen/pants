...
Added default module mappings for `databricks-connect`, `databricks-vectorsearch`, `dbt-core`, `dbt-databricks`, `fpdf2`, `google-ads`, `google-analytics-data`, `google-api-core`, `lingua-language-detector`, `segment-analytics-python`, `umap-learn` and `uuid7`, whose import names differ from their distribution names.
