...
Note that this does not yet support creating multi-platform PEX files. You must continue to use pex lockfiles for this use case. We will support this feature in a follow-up change.
