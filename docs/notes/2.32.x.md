...
Note that this does not yet support creating cloud functions (e.g., AWS Lambdas), or multi-platform PEX files. You must continue to use pex lockfiles for these use cases. We will support these features in a follow-up change.
